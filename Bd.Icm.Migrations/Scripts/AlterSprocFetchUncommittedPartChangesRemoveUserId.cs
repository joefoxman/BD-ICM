...
{
    [Migration(201604131458)]
    public class AlterSprocFetchUncommittedPartChangesRemoveUserId : Migration
    {
...
AS
BEGIN
	WITH SubParts(ParentPartId, PartId, [Name], [Description], [DrawingNumber], [DashNumber], 
		[SerialNumber], [SapPartNumber], [CreatedBy], [CreatedDate], [Creator], [ModifiedBy], [ModifiedDate], [Modifier], 
		InstrumentCommitId, [ModificationStatus], [RowVersion], [Level])
	AS
	(
